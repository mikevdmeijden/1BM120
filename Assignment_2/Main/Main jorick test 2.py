# -*- coding: utf-8 -*-
"""
Created on Mon May 24 10:10:38 2021
...
while True:  # Run until solved
    ...
    for timestep in range(1, max_steps_per_episode):
        ...
        if frame_count < epsilon_random_frames or epsilon > np.random.rand(1)[0]:
            ...
            # From environment 
            state_in = state.reshape(1,600)
            state_tensor = tf.convert_to_tensor(state_in)
        ...
        state_next = state_next.flatten("F")[:-3]
        #print("Observ2:", new_observation_in)
        state_next_in = state_next.reshape(1,600)
        ...
        if frame_count % update_after_actions == 0 and len(done_history) > batch_size:
            ...
            #print(len(state_next_sample))
            # Build the updated Q-values for the sampled future states
            # Use the target model for stability
            #state_next_sample = state_next_sample.reshape(3,201)
    ...
    if done:
        print('Total training rewards: {} after n steps = {} with reward list = {}'.format(episode_reward, episode_count, reward_list))
